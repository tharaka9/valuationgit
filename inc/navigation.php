              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=type" class="nav-link nav-brands">
                        <i class="nav-icon fas fa-copyright"></i>
                        <p>
                         Vehicle Type
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=feature" class="nav-link nav-brands">
                        <i class="nav-icon fas fa-copyright"></i>
                        <p>
                         Vehicle Features
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=valuationcompany" class="nav-link nav-brands">
                        <i class="nav-icon fas fa-copyright"></i>
                        <p>
                         Valuation Company
                        </p>
